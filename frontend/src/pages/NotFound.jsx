...
const NotFound = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#07090e] px-4 text-center">
      {/* Decorative Glow */}
      <div className="absolute w-72 h-72 rounded-full bg-orange-600/10 blur-[120px] pointer-events-none" />

      <div className="max-w-md space-y-6 z-10 animate-fade-in">
        <div className="inline-flex p-4 bg-white/5 rounded-2xl border border-white/5 shadow-xl text-orange-500">
        ...
        <Link
          to={dashboardLink}
          className="inline-flex items-center justify-center px-5 py-2.5 bg-orange-600 hover:bg-orange-500 text-white font-semibold rounded-xl text-sm transition-all shadow-lg shadow-orange-900/20"
        >
